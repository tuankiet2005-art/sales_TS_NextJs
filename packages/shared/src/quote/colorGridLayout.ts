...
const MAX_REPORT_COLORS = 6;

/** Up to six color names in dealer slot order, then any extras from the catalog. */
...
/** Row-major photo indices in a 2-column grid; shorter last rows are centered. */
