...
import {NextRequest, readJsonBody} from "@/server/shared/http";

import { error, json, notFound } from "@/server/shared/http";
import { requireOperator } from "@/server/modules/auth/require-operator";
import {
  getQuoteFilterOptions,
  saveQuoteFromRequest,
  searchQuotes,
} from "@/server/modules/quote/quote-history.service";
