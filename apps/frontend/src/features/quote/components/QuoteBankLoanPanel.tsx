...
import { validateBankLoanInput } from "@/features/quote/lib/bankLoanValidation";
import { fixedRatePeriodOptions, QUOTE_LOAN_TERM_OPTIONS } from "@/features/quote/lib/quoteBankLoan";
import type { Bank, ConsultingEmployee, QuoteBankLoan } from "@onroad/shared/types";
