...
import { motionInteractive, motionStagger } from "@/features/shared/lib/motion";
import { useDoubleTap } from "@/features/shared/lib/useDoubleTap";
import { saveExtras } from "@/features/quote/lib/quoteExtras";
import { savePolicyChoices } from "@/features/quote/lib/quotePolicy";
import type { QuoteExtras, QuoteHistory } from "@onroad/shared/types";
...
interface StoredQuotePayload {
  ...
  deposit?: number;
  bankLoan?: import("@onroad/shared/types").QuoteBankLoan;
  listPrice?: number;
