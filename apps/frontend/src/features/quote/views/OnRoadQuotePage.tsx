...
import { customerFieldsFromCustomer } from "@/features/customer/lib/customerAddress";
import { Header } from "@/features/shared/components/Header";
import { PageLoadingScreen } from "@/features/shared/components/LoadingState";
import { QuoteAccessoriesPanel, QuotePricePanel } from "@/features/quote/components/QuoteAdjustments";
import { QuoteBankLoanPanel } from "@/features/quote/components/QuoteBankLoanPanel";
import { QuoteSheet } from "@/features/quote/components/QuoteSheet";
...
import { loadLocationCache, saveLocationCache } from "@/features/catalog/lib/catalogReferenceCache";
import { motionInteractive, motionPress } from "@/features/shared/lib/motion";
import { DEFAULT_QUOTE_BANK_LOAN, pickDefaultConsultingEmployee, resolveQuoteBankLoan } from "@/features/quote/lib/quoteBankLoan";
import { extrasFromQuote, extrasFromVehicle, extrasStorageKey, loadExtras, saveExtras } from "@/features/quote/lib/quoteExtras";
import { modelToSlug } from "@/features/catalog/lib/modelSlug";
import { loadVehicleCache, saveVehicleCache } from "@/features/catalog/lib/vehicleCache";
import { defaultPolicyChoices, loadPolicyChoices } from "@/features/quote/lib/quotePolicy";
import type {
  Bank,
  ConsultingEmployee,
      ...
      <main className="mx-auto max-w-page px-4 py-5 sm:px-6 sm:py-6 print:max-w-none print:px-0">
        ...
        {vehicle && result && (
          <div className="motion-scale-in overflow-hidden rounded-2xl border border-ink/10 bg-white shadow-card print:mx-0 print:border-0 print:px-0 print:shadow-none">
            <div className="flex justify-center px-1 py-2 print:p-0">
