...
describe("rewriteCssColorFunctions", () => {
  it("replaces nested oklch inside color-mix so PNG/PDF capture never sees those functions", () => {
  ...
  it("replaces nested lab inside declarations so PNG/PDF capture never sees those functions", () => {
