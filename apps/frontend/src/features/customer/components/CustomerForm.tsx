...
import { emptyStructuredAddress } from "@/features/customer/lib/customerAddress";
import { CUSTOMER_RELATIONSHIP_TYPES } from "@/features/customer/lib/customerRelationships";
import { formatVnd } from "@/features/shared/lib/format";
import type { Customer, CustomerDetail, CustomerRelationshipInput, Location } from "@onroad/shared/types";
import type { StructuredAddress } from "@/features/customer/lib/customerAddress";
