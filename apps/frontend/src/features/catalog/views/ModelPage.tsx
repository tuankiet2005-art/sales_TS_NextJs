...
import { CustomerPicker } from "@/features/customer/components/CustomerPicker";
import { ColorPhotoImage } from "@/features/catalog/components/ColorPhotoImage";
import { Header } from "@/features/shared/components/Header";
import { PageLoadingScreen } from "@/features/shared/components/LoadingState";
import { ModelConfigBar } from "@/features/catalog/components/ModelConfigBar";
import { VehicleImageSlideshow } from "@/features/catalog/components/VehicleImageSlideshow";
import { useI18n } from "@/i18n/LanguageContext";
import type { Lang } from "@/i18n/translations";
import { formatVnd } from "@/features/shared/lib/format";
import { codedOption } from "@/features/shared/lib/labels";
import {
...
} from "@/features/customer/lib/customerAddress";
import { priceVehicleFromPolicy } from "@/features/catalog/lib/dealerPricing";
import { slugToModel } from "@/features/catalog/lib/modelSlug";
import { motionInteractive, motionPress } from "@/features/shared/lib/motion";
import { extrasFromVehicle, loadExtras, saveExtras } from "@/features/quote/lib/quoteExtras";
import {
  loadCategoryCache,
  loadLocationCache,
  saveCategoryCache,
  saveLocationCache,
} from "@/features/catalog/lib/catalogReferenceCache";
import { saveVehicleCache } from "@/features/catalog/lib/vehicleCache";
import { colorPhoto } from "@/features/catalog/lib/vehicleColor";
import { buildColorSlideUrls } from "@/features/catalog/lib/vehicleGallery";
import { defaultPolicyChoices, loadPolicyChoices, localizedPolicyText, savePolicyChoices } from "@/features/quote/lib/quotePolicy";
import type { Category, DealerOffer, DealerPolicy, Location, QuoteExtras, UsageType, VehicleDetail, VehicleModelDetail } from "@onroad/shared/types";
