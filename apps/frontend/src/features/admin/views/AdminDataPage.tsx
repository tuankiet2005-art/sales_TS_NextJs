...
import { normalizeColorPhotos, type ColorPhotoMap } from "@/features/catalog/lib/colorPhotos";
import { accessoryImageUrl } from "@/features/catalog/lib/accessoryImageUrl";
import { convertImageFileToWebp } from "@/features/shared/lib/convertImageToWebp";
import { vehicleImageUrl } from "@/features/catalog/lib/vehicleImageUrl";
import { useEffect, useMemo, useRef, useState } from "react";
import { CenteredModal } from "@/features/shared/components/CenteredModal";
import { CurrencyInput } from "@/features/shared/components/CurrencyInput";
import { BankLoanForm } from "@/features/quote/components/BankLoanForm";
import { Header } from "@/features/shared/components/Header";
import { ListFilterSelect } from "@/features/shared/components/ListFilterSelect";
import { LoadingBlock, TableRowsSkeleton } from "@/features/shared/components/LoadingState";
import { DEFAULT_PAGE_SIZE, Pagination } from "@/features/shared/components/Pagination";
import { api, UnauthorizedError } from "@/features/shared/api/client";
import { useAdminAuth } from "@/features/auth/context/AdminAuthContext";
import { useI18n } from "@/i18n/LanguageContext";
import type { Lang } from "@/i18n/translations";
import { getAdminCatalog, invalidateAdminCatalog, type AdminCatalogKey } from "@/features/admin/lib/adminCatalogCache";
import { fillFromVietnamese } from "@/features/admin/lib/fromVietnamese";
import { formatMoneyColumn, isMoneyField } from "@/features/shared/lib/format";
import { accessoryLabel, locationLabel } from "@/features/shared/lib/labels";
import { softIncludes } from "@/features/catalog/lib/softSearch";
import type {
  AdminAccessory,
  AdminBank,
  AdminBankLoan,
